(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.GerminaStack = {}));
  ...
  function Button({ label = "Botão", variant = "primary", type = "button" } = {}) {
  ...
  const ui = window.GerminaStackUI;
